...
public class ConUserApi {
	//详细出入参说明见 企业微信 api https://work.weixin.qq.com/api/doc#90000/90135/90194
	private static String createUrl="https://qyapi.weixin.qq.com/cgi-bin/user/create?access_token=";//创建成员
	private static String uploadUrl="https://qyapi.weixin.qq.com/cgi-bin/user/update?access_token=";//更新成员
	private static String deleteUrl="https://qyapi.weixin.qq.com/cgi-bin/user/delete";//删除成员
	private static String batchDeleteUrl="https://qyapi.weixin.qq.com/cgi-bin/user/batchdelete?access_token=";//批量删除成员
	private static String getUrl="https://qyapi.weixin.qq.com/cgi-bin/user/get";//读取成员
	private static String getDepartmentSimpleListUrl="https://qyapi.weixin.qq.com/cgi-bin/user/simplelist";//获取部门成员
	private static String getDepartmentListUrl="https://qyapi.weixin.qq.com/cgi-bin/user/list";//获取部门成员详情
	private static String inviteUrl="https://qyapi.weixin.qq.com/cgi-bin/invite/send?access_token=";//邀请成员
